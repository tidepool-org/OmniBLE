...
extension OmniBLEPumpManager: PumpManagerUI {
    ...
    public static func setupViewController(initialSettings settings: PumpManagerSetupSettings, bluetoothProvider: BluetoothProvider, colorPalette: LoopUIColorPalette, allowDebugFeatures: Bool, prefersToSkipUserInteraction: Bool = false, allowedInsulinTypes: [InsulinType], basalRateScheduleUpdateHandler: @escaping (BasalRateSchedule) -> Void) -> SetupUIResult<PumpManagerViewController, PumpManagerUI>
    {
